...
class CityDataTest(unittest.TestCase):
    ...
    def testCityTable(self):
        self.assertNotEqual(self.x, None)
...
class ColorTableTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.x.add_row(["Hobart", 1357, 205556, 619.5], fore_color='white', back_color='on_blue')
        self.x.add_row(["Sydney", 2058, 4336374, 1214.8])
        self.x.add_row(["Melbourne", 1566, 3806092, 646.9])
        self.x.add_row(["Perth", 5386, 1554769, 869.4])
        ...
        self.y.add_row(["Hobart", 1357, 205556, 619.5])
        self.y.add_row(["Sydney", 2058, 4336374, 1214.8])
        self.y.add_row(["Melbourne", 1566, 3806092, 646.9])
        self.y.add_row(["Perth", 5386, 1554769, 869.4])

    def test_color_exists(self):
        print(self.x)
        self.assertNotEqual(self.x, self.y, "The color table should be different than the non-color table")
